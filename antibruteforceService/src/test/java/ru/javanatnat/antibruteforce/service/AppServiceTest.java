...
public class AppServiceTest {
    ...
    static class Config {
        ...
        @Bean
        AppService antiBruteforceService() {
    ...
    void isBruteforceTest() {
        assertThat(appService.isBruteforce(LOGIN_TIME, PASSWORD, IP_1)).isFalse();
        assertThat(appService.isBruteforce(LOGIN_TIME, PASSWORD, IP_1)).isFalse();
        assertThat(appService.isBruteforce(LOGIN_TIME, PASSWORD, IP_1)).isTrue(); // by login

        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_1)).isFalse();
        assertThat(appService.isBruteforce(LOGIN, PASSWORD_BRUTEFORCE, IP_1)).isTrue(); // by password
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_BRUTEFORCE)).isTrue(); // by ip
    }

    @Test
    void whitelistTest() {
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_IN_WHITELIST)).isFalse();
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_IN_WHITELIST)).isFalse();
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_IN_WHITELIST)).isFalse();
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_SIMPLE_NOT_LIST)).isFalse();
    }

    @Test
    void blacklistTest() {
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_IN_BLACKLIST)).isTrue();
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_IN_BLACKLIST)).isTrue();
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_IN_BLACKLIST)).isTrue();
        assertThat(appService.isBruteforce(LOGIN, PASSWORD, IP_SIMPLE_NOT_LIST)).isFalse();
    }
